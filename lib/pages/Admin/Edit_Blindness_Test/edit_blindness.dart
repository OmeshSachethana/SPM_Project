  ...
  Widget build(BuildContext context) {
    return
      SafeArea(
        child: Scaffold(
          appBar: AppBar(
            title: const Text('Edit blindness problem Testing'),
            ...
            leading: IconButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) =>  Admin(frontCamera: widget.frontCamera,),
                  ),
                );
              },
            ),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      if (textAnswerController.text.isNotEmpty || _selectedImage != null) {
                        ...
                        apiService.uploadBlindnessImageToFirebase(_selectedImage!,textAnswerController.text, (double progress) {
                          setState(() {
                          ...
                          if (success) {
                            ...
                            apiService.addBlindValueToFirestore(textAnswerController.text);
                            setState(() {
                   ...
                   //   if(mounted) return;
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          ...
                          builder: (context) => ImageGrid(imageUrls, frontCamera: widget.frontCamera,),
                        ),
                      );
                    },
